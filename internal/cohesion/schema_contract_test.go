...
func TestEmbeddedCohesionSchemasAreCurrent(t *testing.T) {
	for _, test := range []struct {
		...
		{path: "../../schema/modules-v1.schema.json", embedded: modulesV1SchemaJSON},
		{path: "../../schema/modules-v2.schema.json", embedded: modulesV2SchemaJSON},
		{path: "../../schema/modules-v3.schema.json", embedded: modulesV3SchemaJSON},
		{path: "../../schema/cohesion-catalog-v1.schema.json", embedded: catalogV1SchemaJSON},
		{path: "../../schema/cohesion-catalog-v2.schema.json", embedded: catalogV2SchemaJSON},
		{path: "../../schema/cohesion-inputs-v1.schema.json", embedded: inputsV1SchemaJSON},
		{path: "../../schema/cohesion-inputs-v2.schema.json", embedded: inputsV2SchemaJSON},
		{path: "../../schema/cohesion-sources-v1.schema.json", embedded: sourcesV1SchemaJSON},
		{path: "../../schema/cohesion-sources-v2.schema.json", embedded: sourcesV2SchemaJSON},
		{path: "../../schema/cohesion-delivery-evidence-v1.schema.json", embedded: deliveryEvidenceV1SchemaJSON},
		{path: "../../schema/cohesion-authorization-registry-v1.schema.json", embedded: authorizationRegistryV1SchemaJSON},
		{path: "../../schema/cohesion-authorization-record-v1.schema.json", embedded: authorizationRecordV1SchemaJSON},
		{path: "../../schema/cohesion-residual-inventory-v1.schema.json", embedded: residualInventoryV1SchemaJSON},
		{path: "../../schema/cohesion-residual-register-v1.schema.json", embedded: residualRegisterV1SchemaJSON},
		{path: "../../schema/cohesion-gate-policy-v1.schema.json", embedded: gatePolicyV1SchemaJSON},
		{path: "../../schema/cohesion-go-toolchains-v1.schema.json", embedded: goToolchainsV1SchemaJSON},
		{path: "../../schema/cohesion-go-official-downloads-oracle-v1.schema.json", embedded: goOfficialDownloadsOracleV1SchemaJSON},
		{path: "../../schema/cohesion-go-official-downloads-oracle-review-v1.schema.json", embedded: goOfficialDownloadsOracleReviewV1SchemaJSON},
		{path: "../../schema/cohesion-engineering-identities-v1.schema.json", embedded: engineeringIdentitiesV1SchemaJSON},
		{path: "../../schema/cohesion-schema-provenance-v1.schema.json", embedded: schemaProvenanceV1SchemaJSON},
		{path: "../../schema/cohesion-schema-provenance-v2.schema.json", embedded: schemaProvenanceV2SchemaJSON},
		{path: "../../schema/cohesion-schema-v3-decision-review-v1.schema.json", embedded: schemaV3DecisionReviewV1SchemaJSON},
		{path: "../../schema/cohesion-schema-v3-decision-freeze-v1.schema.json", embedded: schemaV3DecisionFreezeV1SchemaJSON},
		{path: "../../schema/cohesion-contract-freeze-v1.schema.json", embedded: contractFreezeV1SchemaJSON},
		{path: "../../schema/cohesion-contract-review-v1.schema.json", embedded: contractReviewV1SchemaJSON},
		{path: "../../schema/cohesion-diagnostic-v1.schema.json", embedded: diagnosticV1SchemaJSON},
	} {
