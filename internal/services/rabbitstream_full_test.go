...
func TestManagerStartsFullParallelSafeRabbitStreamTopology(t *testing.T) {
	...
	for key, want := range map[string]string{
		...
		"RABBITSTREAM_NETWORK":                "codex-rabbitstream-task-network",
		"RABBITSTREAM_VOLUME_RABBIT1":         "codex-rabbitstream-task-rabbit1-data",
		"RABBITSTREAM_VOLUME_RABBIT2":         "codex-rabbitstream-task-rabbit2-data",
		"RABBITSTREAM_VOLUME_RABBIT3":         "codex-rabbitstream-task-rabbit3-data",
		"RABBITSTREAM_VOLUME_TLS_CERTS":       "codex-rabbitstream-task-tls-certs",
		"RABBITSTREAM_VOLUME_TLS_DATA":        "codex-rabbitstream-task-tls-data",
