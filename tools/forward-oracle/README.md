...
The diagnostic asset is the first completed lane. Additional schema lanes must
be added only with their decision-matrix cases, independent expected outcomes,
