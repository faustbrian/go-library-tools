...
from generate_aggregate_review import ORACLE_REL, sha
...
def verify(path: Path) -> None:
    ...
    if value.get("status") != "incomplete-non-authorizing" or value.get("authorization") != {"authorized": False, "reason": "17 schema paths lack authoritative accepted and rejected semantic fixtures"}:
